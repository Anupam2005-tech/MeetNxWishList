...
export function HeroSection() {
  return (
    <section className="relative w-full h-[80vh] min-h-[500px] flex items-center justify-center bg-background bg-grid-pattern overflow-hidden pt-16 sm:pt-20"> {/* Added top padding for header */}
