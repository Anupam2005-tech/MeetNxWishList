...
export function Header() {
  return (
    <header className="py-4 sm:py-6 bg-background/90 backdrop-blur-md border-b border-border/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <Link href="/" className="text-2xl sm:text-3xl lg:text-4xl font-bold transition-colors">
        ...
        <GradientBorderButton
          ...
          contentClassName="px-4 py-2 text-base lg:px-5 lg:py-2.5 lg:text-lg"
        >
          Contact Us
        </GradientBorderButton>
      </div>
